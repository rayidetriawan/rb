...
@section('title', 'Query RB')
@section('nav_active_query_rb', 'active')
@section('content')
            ...
            <div class="card" id="orderList">
                <div class="card-header  border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">Query RB</h5>
                            ...
                            <table class="table table-nowrap align-middle" id="orderTable">
                                <thead class="text-muted table-light">
                                    <tr class="text-uppercase">
                                        ...
                                        <th class="sort" data-sort="product_name">Item</th>
                                    ...
                                    @foreach ($data as $no => $hist)
                                        <tr>
                                            ...
                                            <td class="id align-top">
                                                    {{ $hist->rb_id }}<br>
                                                    <div class="text-muted">Branch : {{ $hist->cabang['branch_name'] }}</div> 
                                            </td>
                                            <td class="align-top">
