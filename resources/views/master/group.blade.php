                                ...
                                <div>
                                    <label for="validationCustom02"
                                        ...
                                        <select multiple="multiple" name="izin[]" id="multiselect-optiongroup" required>
                                            ...
                                            <optgroup label="App Ticketing">
                                                <option value="21">Ticketing</option>
                                                <option value="22">Persetujuan Ticket</option>
                                                <option value="23">Penugasan Ticket</option>
                                            </optgroup>
                                            <optgroup label="Master Data">
                                                ...
                                                <option value="24">Kategori Masalah Ticket</option>
                                            </optgroup>
                                        </select>
