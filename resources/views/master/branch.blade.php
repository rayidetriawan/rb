                    ...
                    <form action="{{ route('branch.simpan') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('branch_id') text-danger @enderror">ID Branch</label>
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('nama_branch') text-danger @enderror">Name Branch</label>
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('city') text-danger @enderror">City</label>
        ...
        <div class="col-xl-9">
            <div div class="card">
                <div class="card-header" >
                    <h6 class="card-title mb-0 font-poppins fs-15" >Master Branch</h6>
                </div>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="email">Branch Name</th>
