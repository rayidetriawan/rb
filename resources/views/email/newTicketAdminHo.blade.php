                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Permintaan <b style="color: #000000">RB BARU</b> {{ $details['rb_id'] }},
                                ...
                                <tr>
                                  <td style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; line-height: 1.5; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px;">Klik tautan dibawah untuk login.</td>
                                </tr>
                                <tr>
                                  
                                    <td align="center" style="font-size:0px;padding:25px 25px;padding-bottom:40px;word-break:break-word;">
                                        <a href="http://tua.com/pengajuan/detail/{{ $details['rb_id'] }}" target="_blank">
