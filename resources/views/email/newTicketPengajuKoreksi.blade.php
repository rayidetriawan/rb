...
<html>
  ...
  <body>
    ...
    <table role="presentation" bolder="0" cellpadding="0" cellspacing="0" class="body">
      <tr>
        <td>&nbsp;</td>
        <td class="container">
          <div class="content">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Permintaan RB anda ({{ $details['rb_id'] }}) harus dikoreksi! <br>
                                        Koreksi ini diajukan oleh Bapak/Ibu {{ $details['perevisi'] }} dengan catatan : <br>
                                        <em>"{{ $details['alasan'] }}"</em>
                                    </td>
                                </tr>
