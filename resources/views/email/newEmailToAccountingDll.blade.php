                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Permintaan <b style="color: #000000">RB BARU {{ $data['rb_id'] }}</b>,
                                        telah selesai disetujui.
                                    </td>
                                </tr>
                                <tr
                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <tr>
                                  <td style="font-family: 'Roboto', sans-serif; color: #878a99; box-sizing: border-box; line-height: 1.5; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 10px;">Lihat lampiran file untuk informasi lebih detail.</td>
                                </tr>
                                {{-- <tr>
                                  
                                    <td align="center" style="font-size:0px;padding:25px 25px;padding-bottom:40px;word-break:break-word;">
                                        <a href="{{ URL::to('/pdf/'. $data['link']) }}" target="_blank">
